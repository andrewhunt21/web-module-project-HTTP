...
* [✔️] cd into the project base directory `cd web-module-project-HTTP`
* [✔️] Download server dependencies by running `npm install`
* [✔️] Run the local web server by running `node server.js`
* [✔️] Open a new terminal window and cd into the client code `cd client`
